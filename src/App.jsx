...
export default function SLRApp() {
    ...
    return (
      ...
      <section className='w-full fixed bottom-0 z-[9999] bg-black text-white px-4 py-2  text-center  '><span className='font-poppins '>Developed with</span> ❤ <span className='font-poppins '> by Abu Bakr</span></section>
